...
let string_of_lhs_inst = function
  ...
  | DerefAtom	 (dst_reg_i, src_reg_i, src_port_i, dst_port_i)	-> Printf.sprintf "DerefAtom    [ %d %d %d %d ]" dst_reg_i src_reg_i src_port_i dst_port_i
...
let string_of_rhs_inst = function
  | PushAtom     (reg_i, functor_)		-> Printf.sprintf "PushAtom     [ %d %s ]"       reg_i @@ string_of_functor functor_
  | FreeAtom     reg_i				-> Printf.sprintf "FreeAtom     [ %d ]"          reg_i
  | SetLink      (reg_i, port_i, reg_j, port_j) -> Printf.sprintf "SetLink      [ %d %d %d %d ]" reg_i port_i reg_j port_j
  | ReLink       (reg_i, port_i, reg_j, port_j)	-> Printf.sprintf "ReLink       [ %d %d %d %d ]" reg_i port_i reg_j port_j
  | Connect      (reg_i, port_i, reg_j, port_j)	-> Printf.sprintf "Connect      [ %d %d %d %d ]" reg_i port_i reg_j port_j
...
let string_of_rule (rule_name, (reg_size, (lhs_insts, rhs_insts))) =
  String.concat "\n"
  @@ [ rule_name ^ " @@";
